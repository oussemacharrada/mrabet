...
@endif
    ...
    <tr>
        ...
        <tr>
            ...
            <td>{{$voyage['etat']}}</td>
            <td><a href="{{action('TacheController@fairePhase1',$voyage->idVoyage)}}" class="btn btn-success btn btn-primary a-btn-slide-text"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>
    ...
    @endif
        ...
        <tr>
            ...
            <tr>
                ...
                <td>{{$voyage['responsablePhase2']}}</td>
                <td>{{$voyage['etat']}}</td>
                <td><a href="{{action('TacheController@fairePhase2',$voyage->idVoyage)}}" class="btn btn-success btn btn-primary a-btn-slide-text"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>
                    <span><strong>View</strong></span></a></td>
            </tr>
