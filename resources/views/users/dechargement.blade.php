...
<body style="background-color: #dcdcdc ">
    <nav class="navbar navbar-inverse" style="background-color:black">
        <div class="container-fluid">
         ...
         <a href="{{action('DommageController@index',$id_remorque)}}  " class="btn btn-danger navbar-btn" >Dommage list</a>
        </div>
      </nav>
      @if (count($errors) > 0)
    ...
    @endif
<form id="addDommage" class="md-form"  action="{{action('DommageController@store',$id_remorque)}}" method="POST"  enctype="multipart/form-data">
    ...
    <div class="grid" style="padding:0 10px 0 10px;background-color:#f5f5f5 ;margin:0px">
       ...
       <div style="padding:0 10px 0 10px;background-color:#f5f5f5 ;margin:0px">
        ...
        <div class="col h-25 d-inline-block border border-dark m-1 "><input  type="file" accept="image/*" name="dommageImage"></div>
    <div style="padding:0 10px 0 10px;background-color:#f5f5f5 ;margin:0px">
