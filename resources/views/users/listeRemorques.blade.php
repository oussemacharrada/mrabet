        ...
        <table id="mytable" class="table table-bordred table-striped">
            <tr>
                ...
                <tr>
                    ...
                    <td><a href="" class="btn btn-primary a-btn-slide-text"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                            <span><strong>Edit</strong></span> </td>
                    <td><a href="{{action('remorqueController@deleteRemorque',$Remorque->id_remorque)}}" class="bg-danger btn btn-primary a-btn-slide-text"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span>
            ...
            <table id="mytable" class="table table-bordred table-striped">
                <tr>
                    ...
                    <tr>
                        ...
                        <div class="pull-right action-buttons">
                        <td><a href="{{action('remorqueController@cDommagephase2',$Remorque->id_remorque)}}"style="background: linear-gradient(to right, #2196f3, #f44336);font-family:Gill Sans" class="btn btn-primary a-btn-slide-text">
