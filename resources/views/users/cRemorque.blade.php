...
<div class="row justify-content-center">
    <button name ='action' value="createDommage" type="submit" style="background: linear-gradient(to right, #2196f3, #f44336);font-family:Gill Sans" class=" btn-lg mr-5">creér dommage</button>
    <button name ='action' value=" constat" type="submit" style="background:#ffb300 ;;"  class="btn btn-lg ml-5"> constat</button>
</div>
