                ...
                <div class="card-body">
                    <form method="POST" action="{{action('voyageController@update',$idVoyage)}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cin" type="text" class="form-control @error('portDeChargement') is-invalid @enderror" name="portDeChargement" value="{{ $voyage->portDeChargement}}"   required autocomplete="portDeChargement">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="portDeDechargement" type="text" class="form-control @error('portDeDechargement') is-invalid @enderror" name="portDeDechargement" value="{{ $voyage->portDeDechargement }}" required autocomplete="portDeDechargement">
