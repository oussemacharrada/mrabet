...
@else
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-bars"></i><a href="{{ route('CVoyage') }}">Add voyages</a></li>
                            <li><i class="menu-icon fa fa-puzzle-piece"></i><a href="{{ route('CVoyageList') }}">liste voyages</a></li>
