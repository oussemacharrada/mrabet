...
<body style="background-color: #dcdcdc ">
    ...
    <form id="addDommage" action="{{action('DommageController@store',$id_remorque)}}" method="POST">
        ...
        <div class="grid-1" style=" margin:4px 20px 4px 20px;background-color: #dcdcdc ;color:black ">
            <div class="grid" style="background-color:#a8e4a0;border-radius:7px ;">
                <label for="indentification">indentification</label>
                <input type="text" style="margin: 0;width:180px;" name="indentification"
                    value='{{$remorque->identification}}' placeholder="enter indentification">
                @csrf
                ...
                @csrf
                <input type="text" name="plomb" style="margin: 0;width:180px;" value='{{$remorque->plomb}}'
                    placeholder="enter plomb ">
                @if ($errors->has('Plomb'))
                <strong>{{ $errors->first('Plomb') }}</strong>
                @endif
                <label for="Type">Type</label>
                @csrf
                <input type="text" name="Type" style="margin: 0 6px ;width:180px;" value='{{$remorque->type}}'
        ...
        <div style="padding:10px ;background-color:#f5f5f5 ;margin:0px">
            ...
            <div class="grid-5">
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Porte ar">Porte ar
                </div>
                <!--Bavette-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Bavette">Bavette
                </div>
                <!--Tendeur de bache-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Tendeur de bache">Tendeur de bache
                </div>
                <!--Manivelle-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                ...
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Plaque de glissement">Plaque de glissement
                </div>
                <!--cremone-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Cremone">Cremone
                </div>
                <!--Joint de port ar -->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Joint de port ar">Joint de port ar
                </div>
                <!--Cordon tir-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Cordon tir">Cordon tir
                </div>
                <!--Coussin susp. pneuma.-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Coussin susp. pneuma.">Coussin susp. pneuma.
                </div>
                <!--Prise electrique-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Prise electrique">Prise electrique
                </div>
                <!--poignee-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Poignee">Poignee
                </div>
                <!--Charniere de porte -->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Charniere de porte">Charniere de porte
                </div>
                <!--Ridelle aluminium-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Ridelle aluminium">Ridelle aluminium
                </div>
                <!--Garde boue-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Garde boue">Garde boue
                </div>
                <!--Porte groupe frigo-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Porte groupe frigo">>Porte groupe frigo
                </div>
                <!--pare choc-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Pare choc">Pare choc
                </div>
                <!--Patte de douane-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Patte de douane">Patte de douane
                </div>
                <!--Rancher-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                ...
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Reservoir gasoile">Reservoir gasoile
                </div>
                <!--Cache moteur gf-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Cache moteur gf">Cache moteur gf
                </div>
                <!-- support pare choc-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Support pare choc">Support pare choc
                </div>
                <!--Guide cremone-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Guide cremone">Guide cremone
                </div>
                <!--Planche rehausse-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Planche rehausse">Planche rehausse
                </div>
                <!--Porte extincteur -->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Porte extincteur">Porte extincteur
                </div>
                <!--Protect. condenseur gf-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Protect. condenseur gf">Protect. condenseur gf
                </div>
                <!--barre anti encastrement -->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Barre anti encastrement">Barre anti encastrement
                </div>
                <!--Auberon-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Auberon">Auberon
                </div>
                <!--Protection latirale-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Protection latirale">Protection latirale
                </div>
                <br>
                <br>
                <!--Batterie gf-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Batterie gf">Batterie gf
                </div>
                <!--Montant ar -->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Montant ar">Montant ar
                </div>
                <!--Butoir-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                ...
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Pare cycliste">Pare cycliste
                </div>
                <!--Montant av-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Montant av">Montant av
                </div>
                <!--Bandeau superieur gf-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Bandeau superieur gf">Bandeau superieur gf
                </div>
                <!--Traverse ar-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Traverse ar">Traverse ar
                </div>
                <!--Triangle-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                ...
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Bequille">Bequille
                </div>
                <!--Traverse av-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Traverse av">Traverse av
                </div>
                <!--Butoir-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                ...
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Feu stop">Feu stop
                </div>
                <br>
                <!--Sup platine bequille-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Sup platine bequille">Sup platine bequille
                </div>
                <!--Tablier frontal-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Tablier frontal">Tablier frontal
                </div>
                <br>
                <!--Support feu stop-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Support feu stop">Support feu stop
                </div>
                <br>
                <!--Tiran bequ court-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Tiran bequ court">Tiran bequ court
                </div>
                <!--Angle av-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Angle av">Angle av
                </div>
                <!--Tempéraute-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Temperaute">Temperaute
                </div>
                <!-- Cabochon pare choc-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Cabochon pare choc">Cabochon pare choc
                </div>
                <!--Paroi lisse -->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Paroi lisse">Paroi lisse
                </div>
                <!--Tiran bequ long-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Tiran bequ long">Tiran bequ long
                </div>
                <!--Main de frein-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Main de frein">Main de frein
                </div>
                <!--Etat neuf-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Etat neuf">Etat neuf
                </div>
                <!--Feu de gabrit -->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Feu de gabrit ">Feu de gabrit
                </div>
                <!--Paroi ondulee-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Paroi ondulee">Paroi ondulee
                </div>
                <!--Sabot mobile-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Sabot mobile">Sabot mobile
                </div>
                <!--boitier mdf-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="boitier mdf">boitier mdf
                </div>
                <!--R.A.S-->
                <div class="custom-control custom-radio">
                ...
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Feu led de gabrit">Feu led de gabrit
                </div>
                <!--Bache-->
                <div class="custom-control custom-radio">
                ...
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Sabot fix">Sabot fix
                </div>
                <!--Support mdf-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Support mdf">Support mdf
                </div>
                <!--Autre...-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                ...
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Cabochon de feu de gabrit">Cabochon de feu de gabrit
                </div>
                <!--Sangle-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                ...
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Pneumatique">Pneumatique
                </div>
                <!--Baguette / jonc av-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Baguette / jonc av">Baguette / jonc av
                </div>
                <br>
                <!--Longeron-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Longeron">Longeron
                </div>
                <!--Bord de rive-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Bord de rive">Bord de rive
                </div>
                <!--Roue de secours-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Roue de secours">Roue de secours
                </div>
                <!--Toiture-->
                <div class="custom-control custom-radio">
                    <input type="radio" class="form-check-input position-static" name="Dommage_Name"
                        value="Toiture">Toiture
                </div>
        ...
        <center>
            <div class="grid-1">
                ...
                <div style= "padding:10px 10px 0 10px; background-color:#f5f5f5 ;margin:0px">
