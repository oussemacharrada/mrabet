...
<form action="{{action('remorqueController@add',$idVoyage)}}" method="POST" enctype="multipart/form-data">
  ...
  <div class="row justify-content-center">
    <button name='action' value="createDommage" type="submit"
      style="background: linear-gradient(to right, #2196f3, #f44336);font-family:Gill Sans" class=" btn-lg mr-5">creér
      dommage</button>
